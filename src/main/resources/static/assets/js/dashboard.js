(function($) {
  ...
  $(function() {
    ...
    if ($('#visitperday').length) {
      var bar2 = new ProgressBar.Circle(visitperday, {
        color: '#fff',
        strokeWidth: 15,
        trailWidth: 15,
        easing: 'easeInOut',
	...
	if ($(".navbar").hasClass("fixed-top")) {
	  ...
	  if (navbar) {
	    ...
	    navbar.classList.remove('mt-3');   // ✅ 이게 핵심
	  }
	  ...
	  if (navbar) {
	    navbar.classList.remove('mt-3');   // ✅ 이게 핵심
	    navbar.classList.remove('pt-5');   // ✅ 얘도 제거
	  }
	}
    /*
    // 원래 배너닫기 코드도 요소 있는 경우에만 동작하게 방어 로직 추가 가능
